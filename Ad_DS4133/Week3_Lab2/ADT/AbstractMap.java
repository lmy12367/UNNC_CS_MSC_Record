...
/**
 * An abstract base class to ease the implementation of the ADT.Map interface.
 *
...
public abstract class AbstractMap<K,V> implements Map<K,V> {
  ...
  /**
   * A concrete implementation of the ADT.Entry interface to be used
   * within a ADT.Map implementation.
   */
  protected static class MapEntry<K,V> implements Entry<K,V> {
    ...
    // public methods of the ADT.Entry interface
    public K getKey() { return k; }
    public V getValue() { return v; }

    // utilities not exposed as part of the ADT.Entry interface
